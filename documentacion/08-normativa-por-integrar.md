...
**Integrado al 18 de septiembre de 2026** —carpeta `insumos/normativa/`—:

| Archivo | Ordenamiento | Vigencia |
|---|---|---|
| `01_CONST_CDMX_20260605.pdf` | Constitución Política de la Ciudad de México | ref. 5 jun 2026 |
| `02_LEY_AMBIENTAL_CDMX_20260723.pdf` | Ley Ambiental de la Ciudad de México | ref. 23 jul 2026 |
| `03_REG_IMPACTO_AMBIENTAL_RIESGO_CDMX_20260522.pdf` | Reglamento de Impacto Ambiental y Riesgo | 22 may 2026 |
| `03b_GACETA_1864_REG_IMPACTO_AMBIENTAL_20260522.pdf` | Gaceta Oficial 1864, publicación original del anterior | 22 may 2026 |
| `06_LEY_ORG_PODER_EJECUTIVO_CDMX_20260713.pdf` | Ley Orgánica del Poder Ejecutivo y de la Administración Pública | ref. 13 jul 2026 |
| `07_REG_INTERIOR_PODER_EJECUTIVO_CDMX_20260327.pdf` | Reglamento Interior del Poder Ejecutivo y de la Administración Pública | ref. 27 mar 2026 |
| `08_LEY_ORG_ALCALDIAS_CDMX_20260713.pdf` | Ley Orgánica de Alcaldías | ref. 13 jul 2026 |
| `13_LEY_DESARROLLO_URBANO_DF_20260722.pdf` | Ley de Desarrollo Urbano del Distrito Federal | ref. 22 jul 2026 |
| `16_LEY_ORG_PAOT_CDMX_20251224.pdf` | Ley Orgánica de la PAOT | ref. 24 dic 2025 |
| `17_REG_LEY_ORG_PAOT_CDMX_20181022.pdf` | Reglamento de la Ley Orgánica de la PAOT | 22 oct 2018 |
| `18_NADF_001_RNAT_2015.pdf` | Norma Ambiental de poda, derribo, trasplante y restitución de arbolado | 2015 |
| `19_NADF_006_RNAT_2016.pdf` | Norma Ambiental de fomento, mejoramiento y mantenimiento de áreas verdes | 2016 |
| `LEY_RESIDUOS_SOLIDOS_DF_20250827.pdf` | Ley de Residuos Sólidos del Distrito Federal | ref. 27 ago 2025 |
| `LEY_PROTECCION_BIENESTAR_ANIMALES_CDMX_20240927.pdf` | Ley de Protección y Bienestar de los Animales | ref. 27 sep 2024 |

La versión de la Ley Ambiental de 18 jul 2024 y la copia duplicada de la Ley Orgánica de la PAOT quedaron en `insumos/normativa/_to_delete/` para que el usuario las elimine.
...
|---|---|---|
| ~~**Reglamento Interior del Poder Ejecutivo y de la Administración Pública de la Ciudad de México**~~ **INTEGRADO** | Arts. 191 fracc. III y 188 fraccs. XXXVIII a XLI: sustentan el reparto. Véase marco jurídico, apartado 6 bis | **P-10 resuelto en lo esencial** |
| **Manual Administrativo de la SEDEMA**, con su dictamen de estructura vigente | Ubicación, adscripción y atribuciones de la **Coordinación de Inspección y Vigilancia** de la DGCORENADR; si puede ordenar visitas y sustanciar el procedimiento o sólo ejecutarlas | **P-10**, y perfiles de usuario de **AD-01** |
| **Ley de Residuos Sólidos** *(ley integrada; falta su Reglamento)* | Dos de las dieciocho materias se fundan en ella y hoy se citan sin artículo: residuos sólidos urbanos de establecimientos y residuos de la construcción | Citas del catálogo |
...
| ~~**Reglamento de la Ley Orgánica de la PAOT**~~ **INTEGRADO** | Trámite de la denuncia, ratificación y reconocimiento de hechos. La Ley Orgánica remite a él en los artículos 21 y 25 | **P-01** |
...
| ~~**Norma Ambiental NADF-001-RNAT-2015**~~ **INTEGRADA** | Qué constituye poda, derribo o trasplante indebido; hoy se cita la norma sin poder precisar la conducta | Materia de arbolado |

## 2. Necesarios · sostienen citas que ya están en el prototipo

| Ordenamiento | Para qué |
|---|---|
| **Reglamento de la Ley Ambiental** *(pendiente)*; **Reglamento de Impacto Ambiental y Riesgo** *(integrado)* | El transitorio SEXTO de la Ley Ambiental los mantiene vigentes en lo que no se opongan. Precisan el procedimiento de evaluación de impacto ambiental y las obras que lo requieren |
| ~~**Ley Orgánica del Poder Ejecutivo y de la Administración Pública**~~ **INTEGRADA** | El artículo 7 de la Ley Ambiental remite a ella para las facultades de la Secretaría |
